...
class Model_Finder:
    ...
    def get_best_params_for_naive_bayes(self, train_x, train_y):
        """
         get the parameters for the Naive Bayes's Algorithm which gives the best accuracy.
        ...
        self.logger_object.log(self.file_object, 'Entered the get_best_param_for_naive_bayes method of Model_Finder class.' )
        try:
    ...
    def get_best_params_for_xgboost(self, train_x, train_y):
        """
            get the parameters for XGBoost Algorithm which gives the best accuracy
            Use Hyper Parameter Tuning
        :param train_x:
        :param train_y:
        :return: model with best parameters
    ...
    def get_best_model(self, train_x, train_y, test_x, test_y):
            ...
            try:
                ...
                if len(test_y.unique())== 1: # if there is only in y, then roc_auc_score returns error.We will use accuracy in that case
                    self.xgboost_score = accuracy_score(test_y, self.prediction_xgboost)
                    self.logger_object.log(self.file_object, 'Accuracy score NB:' + str(self.naive_bayes_score))
