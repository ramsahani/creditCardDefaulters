...
class File_Operation:
    ...
    def load_model(self, filename):
        ...
        try:
            with open(self.model_directory + filename +'/' + filename +'.sav','rb') as f:
                self.logger_object.log(self.file_object,'Model file' + filename + 'loaded successfully.Exited the load_model method of File_Operation class.')
    ...
    def find_correct_model_file(self, cluster_number):
        """
         Select the correct model file base on cluster number
