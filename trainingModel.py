...
class trainModel:
    ...
    def trainingModel(self):
        ...
        try:
            ...
            # check if missing values present in the dataset
            is_null_present ,cols_with_missing_values= preprocessor.is_null_present(X)

            # if missing values are there, replace them appropriately.
            if(is_null_present):
                X = preprocessor.impute_missing_values(X, cols_with_missing_values) # missing values imputation
            ...
            for i in list_of_clusters:
                ...
                best_mode_name, best_model = model_finder.get_best_model(train_x,y_train,test_x,y_test)
